...
export function CampaignCard({ interact, renderDuration, title }: CampaignProps) {
	return (
		<div className="w-[288px] h-[310px] px-[6px] py-[18px] flex flex-col">
			...
			<div className="flex flex-col h-[310px] justify-end">
				<p className=" text-[16px] font-bold uppercase leading-[24px] text-white py-1">{title}</p>
				<button
					...
					<img className="w-[20px] h-[20px]" src={'/icons/rightarrow.svg'} alt="Workflow" />
				</button>
			</div>
		</div>
	);
